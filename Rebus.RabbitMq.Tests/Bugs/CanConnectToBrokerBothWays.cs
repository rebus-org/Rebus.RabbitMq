...
namespace Rebus.RabbitMq.Tests.Bugs
{
    ...
    public class CanConnectToBrokerBothWays : FixtureBase
    {
        ...
        public async Task ItWorks_ConnectionEndpoints()
        {
            ...
            Configure.With(activator)
                .Transport(t => t.UseRabbitMq(new List<ConnectionEndpoint> { new ConnectionEndpoint { ConnectionString = RabbitMqTransportFactory.ConnectionString } }, TestConfig.GetName("random-queue")))
                .Start();
